    ...
    Snow.prototype.init = function (element) {
        ...
        for (var i = 0; i < this.flakeCount; i++) {
            var x = Math.floor(Math.random() * this.canvas.width),
                    ...
                    speed = Math.floor(100 * Math.random()) % this.settings.speed + Math.random() * size / 100 + .5,
        ...
        flake.size = Math.floor(100 * Math.random()) % this.settings.size + 2,
                flake.speed = Math.floor(100 * Math.random()) % this.settings.speed + Math.random() * flake.size / 100 + .5,
